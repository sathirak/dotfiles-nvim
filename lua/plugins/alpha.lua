return {
  {
    ...
    opts = function()
      ...
      dashboard.section.header.val = vim.split(logo, "\n")
        ...
        -- stylua: ignore
        dashboard.section.buttons.val = {dashboard.button("r", " Recent", "<cmd> Telescope oldfiles <cr>"),
                                         dashboard.button("s", " Restore",
            [[<cmd> lua require("persistence").load() <cr>]]), dashboard.button("q", " Quit", "<cmd> qa <cr>")}
